...
class MSDeformableAttention(nn.Module):
    def __init__(
        ...
        self.ms_deformable_attn_core = functools.partial(
            deformable_attention_core_func_v2, method=self.method, value_shape=value_shape
        )
...
class TransformerDecoderLayer(nn.Module):
    def __init__(
        ...
        self.cross_attn = MSDeformableAttention(
            d_model, n_head, n_levels, n_points, method=cross_attn_method, value_shape=value_shape
        )
